...
bool DeferredRenderingManager::Initialize(ID3D11Device * device, ID3D11DeviceContext * deviceContext, int windowWidth, int windowHeight)
{
	m_device = device;
	...
	*/
	...
	rttDesc.Width = windowWidth;
	rttDesc.Height = windowHeight;
	rttDesc.MipLevels = 1;
	rttDesc.ArraySize = 1;
	...
	dbDesc.Width = windowWidth;
	dbDesc.Height = windowHeight;
	dbDesc.MipLevels = 1;
	dbDesc.ArraySize = 1;
